...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var descriptionMobile = document.querySelector('.about__description--mobile');
  var addText = document.querySelector('.about__additional');
  var listOpen = document.querySelector('.user-nav__heading');
  var contactOpen = document.querySelector('.contact__heading');
  var navList = document.querySelector('.user-nav__list');
  var contactList = document.querySelector('.contact__box');
  ...
  var accordeonList = [navList, contactList];
  var accordeonOpenList = [contactOpen, listOpen];
  if (window.outerWidth <= 767) {
    accordeonList.forEach(function (item) {
      item.classList.add('accordeon__close');
    });
    accordeonOpenList.forEach(function (element) {
      element.tabIndex = 0;
    });
  }
  var activeAccordion;
